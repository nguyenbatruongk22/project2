...
namespace Phukienthucung.Controllers
{
    public class SAN_PHAMController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSP,TenSP,MoTa,Gia,Hinh_anh,Trang_thai")] SAN_PHAM sAN_PHAM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSP,TenSP,MoTa,Gia,Hinh_anh,Trang_thai")] SAN_PHAM sAN_PHAM)
        {
            if (ModelState.IsValid)
            {
